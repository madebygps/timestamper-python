...
def group_sentences(
    captions: List[Tuple[str, float]], group_size: int
...
def split_into_chapters_by_topic(
    captions: List[Tuple[str, float]], group_size: int = 10, threshold: float = 0.1
    ...
    chapters = [
        grouped_captions[breakpoints[i] : breakpoints[i + 1]]
